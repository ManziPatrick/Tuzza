  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-worksans  mt-0 justify-end mx-auto pt-[9px] md:text-sm w-full">
          ...
          <div className="h-[654px] md:px-5 relative w-full">
            ...
            <div className="absolute bottom-[7%] flex flex-col gap-[42px] inset-x-[0] justify-start md:justify-center mx-auto w-1/2">
              <div className="bg-blue_gray-100_66 flex flex-col items-center justify-start p-[30px] sm:px-5 w-full">
                <Text
                  className="leading-[60.00px] my-[15px] sm:text-[24px] md:text-[32px] text-[49px] text-center text-white-A700"
              ...
              <Button
                className="border border-solid border-teal-600 cursor-pointer font-bold leading-[normal] min-w-[253px] md:ml-[0] ml-[359px] mr-[185px] text-center text-xl tracking-[-0.40px]"
                size="md"
              >
                Explore Tuuza
              </Button>
          ...
          <Text
            className="md:ml-[0]  mt-[41px] text-5xl sm:text-[38px] md:text-[44px] text-black-900 text-center tracking-[-0.96px]"
            size="txtWorkSansBold48"
          >
            Welcome to Tuuza
          </Text>
          <Text
            className="mt-[30px]  text-center text-xl md:text-[22px] text-black-900  sm:text-xl tracking-[0.48px] uppercase  "
          ...
          <div className="flex md:flex-col   md:gap-16 justify-around  mt-[135px] md:px-5  md:w-full">
            <div>
            <Text
              className="italic text-5xl sm:text-[38px] md:text-[44px] text-center text-teal-600 tracking-[0.96px] uppercase"
            ...
            <Text
              className="text-2xl md:text-[22px] text-black-900 text-center sm:text-xl tracking-[0.48px] uppercase"
            ...
            <Text
              className="italic  text-5xl sm:text-[38px] md:text-[44px] text-center text-teal-600  uppercase"
              size="txtWorkSansItalicExtraBold48"
            >
              40+
            </Text>
          ...
          <div className="bg-teal-600 flex flex-col items-center justify-start mt-[122px] p-[20px] sm:px-5 rounded-[51px] w-full">
            <div className="flex  items-center justify-around  mb-3 mt-[50px]  md:px-5 w-full">
              <div className="flex flex-col justify-start w-full">
                <Text
                  className="md:ml-[0] ml-[45px] sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-left   md:text-center tracking-[2.80px] uppercase"
                ...
                <div className="flex flex-col md:gap-10 gap-[20px] items-center justify-start w-full">
                  <div className="flex md:flex-col  flex-row md:gap-10 items-center justify-between w-full">
                    <Text
                      className="text-2xl md:text-[22px] w-3/2 mt-4 text-black-900 text-center sm:text-xl tracking-[3.48px] uppercase w-1/2"
                      size="txtWorkSansRomanRegular24"
                    >
                  ...
                  <div className="flex md:flex-col flex-row  items-center justify-around w-full">
                    <div className="flex flex-col md:gap-10 gap-[20px] justify-start">
                      <Text
                        className="md:ml-[0] sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center tracking-[0.80px] uppercase"
                        size="txtWorkSansRomanBold40"
                      >
                        conference rooms
                      </Text>
                      <Text
                        className="text-2xl md:text-[22px] text-black-900 text-center  pb-4 sm:text-xl tracking-[0.48px] uppercase w-3/2 sm:w-full"
                        size="txtWorkSansRomanRegular24"
                      >
                        Tuuza is a unique community space for sports, culture,
                        retreat, research, and development. Our mission revolves
          ...
          <div className="flex md:flex-col flex-row gap-[21px] items-start justify-start max-w-[1369px] mt-[95px] mx-auto w-full">
            <div className="flex md:flex-1 flex-col md:gap-10 gap-20  md:mt-0 mt-3.5 md:order-2 md:w-full">
              ...
              <Text
                className="sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center tracking-[0.80px] uppercase"
                size="txtWorkSansRomanBold40"
              >
                bar and restorent
              </Text>
            ...
            <div className="flex flex-col md:flex-1 gap-8 ">
              ...
              <Text
                className="text-2xl md:text-[22px] text-black-900 text-center sm:text-xl  tracking-[0.48px] uppercase w-full"
                size="txtWorkSansRomanRegular24"
              >
                Tuuza is a unique community space for sports, culture, retreat,
                research, and development. Our mission revolves around uniting{" "}
          ...
          <div className="flex md:flex-col flex-row md:gap-10 gap-5 items-start justify-end md:ml-[0] ml-[124px] md:px-5 w-[88%] md:w-full">
            <Text
              className="md:mt-0 mt-12 text-2xl  md:text-[22px] text-black-900 text-center sm:text-xl tracking-[0.48px] uppercase w-[30%] md:w-full sm:w-full"
              size="txtWorkSansRomanRegular24"
            >
              Tuuza is a unique community space for sports, culture, retreat,
              research, and development. Our mission revolves around uniting{" "}
          ...
          <Text
            className="md:ml-[0] mt-0.5 sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center tracking-[0.80px] uppercase"
            size="txtWorkSansRomanBold40"
          >
            playgrounds
          </Text>
          <div className="flex font-roboto h-[520px] md:h-[534px] justify-end max-w-[1352px] mt-3.5 mx-auto md:px-5 relative w-full">
            <Text
              className="mb-[131px] ml-[103px] mt-auto text-black-900 text-xl"
              size="txtRobotoRomanSemiBold20"
            >
            
            </Text>
            <Img
              className="absolute inset-[0] justify-center m-auto object-cover w-full"
...
>
  View More
          ...
          <div className="bg-teal-600 md:bg-white-A700 flex flex-col font-roboto items-center justify-start mt-[70px] p-20 sm:px-5 rounded-[51px] w-full">
  ...
  <Text
    className="italic md:ml-[0] text-5xl sm:text-[38px] md:text-[44px] text-blue_gray-900 text-center sm:w-full"
  ...
  <div className="flex md:flex-col md:gap-8 items-center justify-around mt-20 w-full">
    <div className="card bg-white-A700 flex md:flex-1 flex-col items-center p-8 sm:px-5 shadow-md w-[28%] md:w-full rounded-[51px]">
      ...
      <Text className="leading-[18.00px] md:ml-[0] mt-10 text-black-900 text-xl">
        <>
    ...
    <div className="card flex md:flex-1 md:flex-col justify-around md:gap-10 items-center md:w-full">
      <div className="card bg-white-A700 flex flex-col rounded-[51px] items-center justify-center p-8 sm:px-5 shadow-md w-[44%] ms:w-full md:w-full">
        <div className="rounded-full overflow-hidden w-16 h-16 md:h-auto w-1/4 h-12 md:ml-[0]">
          <Img src="images/2.jpg" alt="rectangleTwo_One" className="w-full h-full object-cover" />
        </div>
        <Text className="leading-[18.00px] md:ml-[0] mt-[38px] text-black-900 text-xl w-4/5">
          <>
            Tuuza's cuisine left a delicious impression on us!
          </>
        </Text>
        <Text className="md:ml-[0] mt-[94px] text-black-900 text-center text-xl" size="txtRobotoRomanSemiBold20">
          Samantha Brown
        </Text>
      </div>
      <div className="card bg-white-A700 flex flex-col rounded-[51px] justify-center p-8 sm:px-5 items-center shadow-md w-[44%] md:w-full">
        ...
        <Text className="md:ml-[0] mt-[94px] text-black-900 text-xl" size="txtRobotoRomanSemiBold20">
          Samantha Brown
              ...
              <div className="mt-7">
                    <Text  className=" mb-7 text-4xl sm:text-[38px]  mt-4 md:text-[44px] text-[64px] text-black-900 text-center"
                      size="txtRobotoRomanExtraBold48"
                    >
                      join us
                    </Text>
                    <Text
                      className="leading-[40.00px] md:ml-[0]  mt-[9px] text-black-900 text-center"
